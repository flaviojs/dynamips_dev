...
pub const VM_PAGE_IMASK: m_iptr_t = VM_PAGE_SIZE as m_iptr_t - 1;
pub const VM_PAGE_MASK: m_iptr_t = !VM_PAGE_IMASK;
...
// VM instance status
pub type _VM_STATUS_ENUM = c_int; // TODO enum
pub const VM_STATUS_HALTED: _VM_STATUS_ENUM = 0; // VM is halted and no HW resources are used
pub const VM_STATUS_SHUTDOWN: _VM_STATUS_ENUM = 1; // Shutdown procedure engaged
pub const VM_STATUS_RUNNING: _VM_STATUS_ENUM = 2; // VM is running
pub const VM_STATUS_SUSPENDED: _VM_STATUS_ENUM = 3; // VM is suspended

// Ghost RAM status
pub type _VM_GHOST_ENUM = c_int; // TODO enum
pub const VM_GHOST_RAM_NONE: _VM_GHOST_ENUM = 0;
pub const VM_GHOST_RAM_GENERATE: _VM_GHOST_ENUM = 1;
pub const VM_GHOST_RAM_USE: _VM_GHOST_ENUM = 2;
...
pub struct vm_platform {
    ...
    pub nvram_extract_config:
        Option<unsafe extern "C" fn(vm: *mut vm_instance_t, startup_config: *mut *mut u_char, startup_len: *mut size_t, private_config: *mut *mut u_char, private_len: *mut size_t) -> c_int>,
