...
pub const MIPS_CP0_STATUS_KSU_SHIFT: c_int = 0x03;
pub const MIPS_CP0_STATUS_KSU_MASK: m_uint32_t = 0x03;

pub const MIPS_CP0_STATUS_KM: m_uint32_t = 0x00;
pub const MIPS_CP0_STATUS_SM: m_uint32_t = 0x01;
pub const MIPS_CP0_STATUS_UM: m_uint32_t = 0x10;
...
pub const MIPS_CP0_CAUSE_INTERRUPT: c_int = 0;
pub const MIPS_CP0_CAUSE_TLB_MOD: c_int = 1;
pub const MIPS_CP0_CAUSE_TLB_LOAD: c_int = 2;
pub const MIPS_CP0_CAUSE_TLB_SAVE: c_int = 3;
pub const MIPS_CP0_CAUSE_ADDR_LOAD: c_int = 4; // ADEL
pub const MIPS_CP0_CAUSE_ADDR_SAVE: c_int = 5; // ADES
pub const MIPS_CP0_CAUSE_BUS_INSTR: c_int = 6;
pub const MIPS_CP0_CAUSE_BUS_DATA: c_int = 7;
pub const MIPS_CP0_CAUSE_SYSCALL: c_int = 8;
pub const MIPS_CP0_CAUSE_BP: c_int = 9;
pub const MIPS_CP0_CAUSE_ILLOP: c_int = 10;
pub const MIPS_CP0_CAUSE_CP_UNUSABLE: c_int = 11;
pub const MIPS_CP0_CAUSE_OVFLW: c_int = 12;
pub const MIPS_CP0_CAUSE_TRAP: c_int = 13;
pub const MIPS_CP0_CAUSE_VC_INSTR: c_int = 14; // Virtual Coherency
pub const MIPS_CP0_CAUSE_FPE: c_int = 15;
pub const MIPS_CP0_CAUSE_WATCH: c_int = 23;
pub const MIPS_CP0_CAUSE_VC_DATA: c_int = 31; // Virtual Coherency
...
pub const MIPS_TLB_ASID_MASK: m_uint64_t = 0x000000ff; // "asid" in EntryHi
...
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_CP0_LO_SAFE_MASK: m_uint64_t = 0x3fffffff_u64; // Safety mask for Lo reg
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_CP0_HI_SAFE_MASK: m_uint64_t = 0xc00000ffffffe0ff_u64; // Same for EntryHi

// results for TLB lookups
#[cfg(feature = "USE_UNSTABLE")]
pub type _MIPS_TLB_ENUM = c_int; // TODO enum
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_TLB_LOOKUP_OK: _MIPS_TLB_ENUM = 0; // Entry found
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_TLB_LOOKUP_INVALID: _MIPS_TLB_ENUM = 1; // Invalid entry found
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_TLB_LOOKUP_MISS: _MIPS_TLB_ENUM = 2; // No matching entry found
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_TLB_LOOKUP_MOD: _MIPS_TLB_ENUM = 3; // Read-only

// Exceptions vectors
#[cfg(feature = "USE_UNSTABLE")]
pub type _MIPS_EXCVECT_ENUM = c_int; // TODO enum
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_EXCVECT_RST: _MIPS_EXCVECT_ENUM = 0; // Soft Reset, Reset, NMI
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_EXCVECT_TLB_REFILL: _MIPS_EXCVECT_ENUM = 1; // TLB Refill (32-bit)
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_EXCVECT_XTLB_REFILL: _MIPS_EXCVECT_ENUM = 2; // TLB Refill (64-bit)
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_EXCVECT_CACHE_ERR: _MIPS_EXCVECT_ENUM = 3; // Cache Error
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_EXCVECT_INT_IV0: _MIPS_EXCVECT_ENUM = 4; // Interrupt, IV=0
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_EXCVECT_INT_IV1: _MIPS_EXCVECT_ENUM = 5; // Interrupt, IV=1
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_EXCVECT_OTHERS: _MIPS_EXCVECT_ENUM = 6; // Other exceptions
...
pub const MIPS_MIN_PAGE_SIZE: usize = 1 << MIPS_MIN_PAGE_SHIFT;
...
pub const MIPS_INSN_PER_PAGE: usize = MIPS_MIN_PAGE_SIZE / 4;
const _: () = assert!(MIPS_INSN_PER_PAGE == MIPS_MIN_PAGE_SIZE / size_of::<mips_insn_t>());
...
// Memory operations
pub type _MIPS_MEMOP_ENUM = usize; // TODO enum
pub const MIPS_MEMOP_LOOKUP: _MIPS_MEMOP_ENUM = 0;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LB: _MIPS_MEMOP_ENUM = 1;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LBU: _MIPS_MEMOP_ENUM = 2;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LH: _MIPS_MEMOP_ENUM = 3;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LHU: _MIPS_MEMOP_ENUM = 4;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LW: _MIPS_MEMOP_ENUM = 5;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LWU: _MIPS_MEMOP_ENUM = 6;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LD: _MIPS_MEMOP_ENUM = 7;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SB: _MIPS_MEMOP_ENUM = 8;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SH: _MIPS_MEMOP_ENUM = 9;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SW: _MIPS_MEMOP_ENUM = 10;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SD: _MIPS_MEMOP_ENUM = 11;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LWL: _MIPS_MEMOP_ENUM = 12;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LWR: _MIPS_MEMOP_ENUM = 13;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LDL: _MIPS_MEMOP_ENUM = 14;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LDR: _MIPS_MEMOP_ENUM = 15;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SWL: _MIPS_MEMOP_ENUM = 16;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SWR: _MIPS_MEMOP_ENUM = 17;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SDL: _MIPS_MEMOP_ENUM = 18;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SDR: _MIPS_MEMOP_ENUM = 19;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LL: _MIPS_MEMOP_ENUM = 20;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SC: _MIPS_MEMOP_ENUM = 21;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_LDC1: _MIPS_MEMOP_ENUM = 22;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_SDC1: _MIPS_MEMOP_ENUM = 23;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_CACHE: _MIPS_MEMOP_ENUM = 24;
#[cfg(not(feature = "USE_UNSTABLE"))]
pub const MIPS_MEMOP_MAX: _MIPS_MEMOP_ENUM = 25;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_IFETCH: _MIPS_MEMOP_ENUM = 1;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LB: _MIPS_MEMOP_ENUM = 2;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LBU: _MIPS_MEMOP_ENUM = 3;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LH: _MIPS_MEMOP_ENUM = 4;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LHU: _MIPS_MEMOP_ENUM = 5;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LW: _MIPS_MEMOP_ENUM = 6;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LWU: _MIPS_MEMOP_ENUM = 7;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LD: _MIPS_MEMOP_ENUM = 8;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SB: _MIPS_MEMOP_ENUM = 9;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SH: _MIPS_MEMOP_ENUM = 10;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SW: _MIPS_MEMOP_ENUM = 11;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SD: _MIPS_MEMOP_ENUM = 12;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LWL: _MIPS_MEMOP_ENUM = 13;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LWR: _MIPS_MEMOP_ENUM = 14;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LDL: _MIPS_MEMOP_ENUM = 15;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LDR: _MIPS_MEMOP_ENUM = 16;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SWL: _MIPS_MEMOP_ENUM = 17;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SWR: _MIPS_MEMOP_ENUM = 18;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SDL: _MIPS_MEMOP_ENUM = 19;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SDR: _MIPS_MEMOP_ENUM = 20;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LL: _MIPS_MEMOP_ENUM = 21;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SC: _MIPS_MEMOP_ENUM = 22;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_LDC1: _MIPS_MEMOP_ENUM = 23;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_SDC1: _MIPS_MEMOP_ENUM = 24;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_CACHE: _MIPS_MEMOP_ENUM = 25;
#[cfg(feature = "USE_UNSTABLE")]
pub const MIPS_MEMOP_MAX: _MIPS_MEMOP_ENUM = 26;
...
macro_rules! MIPS64_IRQ_LOCK {
    ($cpu:expr) => {
        libc::pthread_mutex_lock(std::ptr::addr_of_mut!((*$cpu).irq_lock))
    };
}
pub(crate) use MIPS64_IRQ_LOCK;
macro_rules! MIPS64_IRQ_UNLOCK {
    ($cpu:expr) => {
        libc::pthread_mutex_unlock(std::ptr::addr_of_mut!((*$cpu).irq_lock))
    };
}
pub(crate) use MIPS64_IRQ_UNLOCK;
