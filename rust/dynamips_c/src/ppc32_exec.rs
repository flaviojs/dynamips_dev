...
#[inline(always)]
#[no_mangle]
pub unsafe extern "C" fn ppc32_rotate_mask(mb: m_uint32_t, me: m_uint32_t) -> m_uint32_t {
...
pub unsafe extern "C" fn ppc32_exec_page(cpu: *mut cpu_ppc_t) -> c_int {
    ...
    (*cpu).njm_exec_ptr = (*cpu).mem_op_lookup.unwrap()(cpu, exec_page, PPC32_MTS_ICACHE as u_int).cast::<_>();
...
pub unsafe extern "C" fn ppc32_exec_run_cpu(gen: *mut cpu_gen_t) -> *mut c_void {
    ...
    if libc::pthread_create(addr_of_mut!(timer_irq_thread), null_mut(), ppc32_timer_irq_run_, cpu.cast::<_>()) != 0 {
