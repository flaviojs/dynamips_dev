...
// CPU identifiers
pub const PPC32_PVR_405: m_uint32_t = 0x40110000; // PowerPC 405GPa
pub const PPC32_PVR_MPC8xx: m_uint32_t = 0x00500000; // PowerPC MPC 8xx cores (aka PowerQUICC)
pub const PPC32_PVR_MPC860: m_uint32_t = PPC32_PVR_MPC8xx | 0x0202; // assumed, because dev_mpc860 is being used
pub const PPC32_PVR_7448_v21: m_uint32_t = 0x80040201; // PowerPC 74xx cores (aka G4)
...
pub const PPC32_INSN_PER_PAGE: usize = PPC32_MIN_PAGE_SIZE / 4;
const _: () = assert!(PPC32_INSN_PER_PAGE == PPC32_MIN_PAGE_SIZE / size_of::<ppc_insn_t>());
...
pub const PPC32_SPR_XER: c_int = 1;
pub const PPC32_SPR_LR: c_int = 8; // Link Register
pub const PPC32_SPR_CTR: c_int = 9; // Count Register
pub const PPC32_SPR_DSISR: c_int = 18;
pub const PPC32_SPR_DAR: c_int = 19;
pub const PPC32_SPR_DEC: c_int = 22; // Decrementer
pub const PPC32_SPR_SDR1: c_int = 25; // Page Table Address
pub const PPC32_SPR_SRR0: c_int = 26;
pub const PPC32_SPR_SRR1: c_int = 27;
pub const PPC32_SPR_TBL_READ: c_int = 268; // Time Base Low (read)
pub const PPC32_SPR_TBU_READ: c_int = 269; // Time Base Up (read)
pub const PPC32_SPR_SPRG0: c_int = 272;
pub const PPC32_SPR_SPRG1: c_int = 273;
pub const PPC32_SPR_SPRG2: c_int = 274;
pub const PPC32_SPR_SPRG3: c_int = 275;
pub const PPC32_SPR_TBL_WRITE: c_int = 284; // Time Base Low (write)
pub const PPC32_SPR_TBU_WRITE: c_int = 285; // Time Base Up (write)
pub const PPC32_SPR_PVR: c_int = 287; // Processor Version Register
pub const PPC32_SPR_HID0: c_int = 1008;
pub const PPC32_SPR_HID1: c_int = 1009;

pub const PPC405_SPR_PID: c_int = 945; // Process Identifier
...
pub(crate) use ppc32_get_cr_field;
macro_rules! ppc32_get_cr_bit {
    ($n:expr) => {
        (!($n) & 0x03)
    };
}
pub(crate) use ppc32_get_cr_bit;

// Positions of LT, GT, EQ and SO bits in CR fields
pub const PPC32_CR_LT_BIT: c_int = 3;
pub const PPC32_CR_GT_BIT: c_int = 2;
pub const PPC32_CR_EQ_BIT: c_int = 1;
pub const PPC32_CR_SO_BIT: c_int = 0;

// CR0 (Condition Register Field 0) bits
pub const PPC32_CR0_LT_BIT: c_int = 31;
pub const PPC32_CR0_LT: m_uint32_t = 1 << PPC32_CR0_LT_BIT; // Negative
pub const PPC32_CR0_GT_BIT: c_int = 30;
pub const PPC32_CR0_GT: m_uint32_t = 1 << PPC32_CR0_GT_BIT; // Positive
pub const PPC32_CR0_EQ_BIT: c_int = 29;
pub const PPC32_CR0_EQ: m_uint32_t = 1 << PPC32_CR0_EQ_BIT; // Zero
pub const PPC32_CR0_SO_BIT: c_int = 28;
pub const PPC32_CR0_SO: m_uint32_t = 1 << PPC32_CR0_SO_BIT; // Summary overflow

// XER register
pub const PPC32_XER_SO_BIT: c_int = 31;
...
pub const PPC32_XER_CA_BIT: c_int = 29;
...
pub const PPC32_BAT_ADDR_SHIFT: c_int = 17;
...
pub const PPC32_PTE_SIZE: usize = 8;
...
pub const PPC32_PTEU_VSID_SHIFT: c_int = 7;
...
pub const PPC32_PTEL_XPN_SHIFT: c_int = 9;
...
pub const PPC32_PTEL_WIMG_SHIFT: c_int = 3;
pub const PPC32_PTEL_X_MASK: m_uint32_t = 0x00000004; // Extended Page Number (3)
pub const PPC32_PTEL_X_SHIFT: c_int = 2;
...
pub const PPC405_TLBHI_SIZE_SHIFT: c_int = 7;
...
pub const PPC405_TLBLO_ZSEL_SHIFT: c_int = 4;
...
// Memory operations
pub type _PPC_MEMOP_ENUM = usize; // TODo enum
pub const PPC_MEMOP_LOOKUP: _PPC_MEMOP_ENUM = 0;
// Instruction fetch operation
pub const PPC_MEMOP_IFETCH: _PPC_MEMOP_ENUM = 1;
// Load operations
pub const PPC_MEMOP_LBZ: _PPC_MEMOP_ENUM = 2;
pub const PPC_MEMOP_LHZ: _PPC_MEMOP_ENUM = 3;
pub const PPC_MEMOP_LWZ: _PPC_MEMOP_ENUM = 4;
// Load operation with sign-extend
pub const PPC_MEMOP_LHA: _PPC_MEMOP_ENUM = 5;
// Store operations
pub const PPC_MEMOP_STB: _PPC_MEMOP_ENUM = 6;
pub const PPC_MEMOP_STH: _PPC_MEMOP_ENUM = 7;
pub const PPC_MEMOP_STW: _PPC_MEMOP_ENUM = 8;
// Byte-Reversed operations
pub const PPC_MEMOP_LWBR: _PPC_MEMOP_ENUM = 9;
pub const PPC_MEMOP_STWBR: _PPC_MEMOP_ENUM = 10;
// String operations
pub const PPC_MEMOP_LSW: _PPC_MEMOP_ENUM = 11;
pub const PPC_MEMOP_STSW: _PPC_MEMOP_ENUM = 12;
// FPU operations
pub const PPC_MEMOP_LFD: _PPC_MEMOP_ENUM = 13;
pub const PPC_MEMOP_STFD: _PPC_MEMOP_ENUM = 14;
// ICBI - Instruction Cache Block Invalidate
pub const PPC_MEMOP_ICBI: _PPC_MEMOP_ENUM = 15;
pub const PPC_MEMOP_MAX: _PPC_MEMOP_ENUM = 16;
...
// BAT type indexes
pub type _PPC32_BAT_ENUM = c_int; // TODO enum
pub const PPC32_IBAT_IDX: _PPC32_BAT_ENUM = 0;
pub const PPC32_DBAT_IDX: _PPC32_BAT_ENUM = 1;
...
pub const PPC32_MTS_ICACHE: _PPC32_BAT_ENUM = PPC32_IBAT_IDX;
pub const PPC32_MTS_DCACHE: _PPC32_BAT_ENUM = PPC32_DBAT_IDX;
...
macro_rules! PPC32_CR_FIELD_OFFSET {
    ($f:expr) => {
        OFFSET!(cpu_ppc_t, cr_fields).add(($f) * size_of::<u_int>())
    };
}
pub(crate) use PPC32_CR_FIELD_OFFSET;
...
pub unsafe extern "C" fn ppc32_get_cr(cpu: *mut cpu_ppc_t) -> m_uint32_t {
    ...
    for i in 0..8 as c_int {
        cr |= (*cpu).cr_fields[i as usize] << (28 - (i << 2));
    }
...
pub unsafe extern "C" fn ppc32_set_cr(cpu: *mut cpu_ppc_t, cr: m_uint32_t) {
    for i in 0..8 as c_int {
        (*cpu).cr_fields[i as usize] = (cr >> (28 - (i << 2))) & 0x0F;
    }
}
